						...
						<!-- 	<div class="price-container info-container m-t-20">
							...
							<div class="quantity-container info-container">
								<div class="row">
									...
									<div class="col-sm-4">
										<span class="label">Mã sản phầm :</span>
									</div>
									
									<div class="col-sm-8">
											<div class="form-group">
										<!-- 	<label for="">label</label> -->
											<input type="text" class="form-control" value="PC190990" id="" placeholder="Input field" disabled>
										</div>
									</div>

									<div class="col-sm-4">
										<span class="label">QUy cách đóng gói :</span>
									</div>
									
									<div class="col-sm-8">
											<div class="form-group">
										<!-- 	<label for="">label</label> -->
											<input type="text" class="form-control" id="" value="1000/thùng" placeholder="Input field" disabled>
										</div>
									</div>
								

									<div class="col-sm-4">
										<span class="label">Số lượng cần mua :</span>
									</div>
									
									<div class="col-sm-8">
											<div class="form-group">
										<!-- 	<label for="">label</label> -->
											<input type="text" class="form-control" id="" placeholder="Nhập số lượng cần mua">
										</div>
									</div>
									...
									<div class="col-sm-12">
											<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal"> <i class="fa fa-shopping-cart inner-right-vs"></i>Báo giá ngay</button>
									</div>
